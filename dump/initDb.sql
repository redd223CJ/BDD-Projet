...
CREATE TABLE IF NOT EXISTS ARRET_DESSERVI(
    ...
    PRIMARY KEY(ITINERAIRE_ID, SEQUENCE) -- à vérifier
);
...
CREATE TABLE IF NOT EXISTS HORAIRE(
    ...
    HEURE_DEPART TIME,
    PRIMARY KEY(TRAJET_ID, ARRET_ID) -- à vérifier
);
...
CREATE TABLE IF NOT EXISTS SERVICE(
    ...
    LUNDI VARCHAR(1) NOT NULL,
    MARDI VARCHAR(1) NOT NULL,
    MERCREDI VARCHAR(1) NOT NULL,
    JEUDI VARCHAR(1) NOT NULL,
    VENDREDI VARCHAR(1) NOT NULL,
    SAMEDI VARCHAR(1) NOT NULL,
    DIMANCHE VARCHAR(1) NOT NULL,
...
-- Modification des tables, pour clés étrangères
...
-- Chargement des fichiers CSV (ordre corrigé)
